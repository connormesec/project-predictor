  ...
  return (
    <div>
      ...
      <Typography variant="body1" align="left" className={classes.sublist}>
        ...
        status before devs begin progress on a ticket. This field is defaulted to "New" in the app so you will need to add "Ready for Dev" to the Start Column Overwrite field.
      </Typography>
      <Typography variant="body1" align="left" className={classes.sublist}>
      ...
      <Typography variant="body1" align="left" className={classes.body}>
        <b>Start Column:</b> Defaults to "New". Add the status that devs move tickets out of as they transition tickets to "In Progress". See Getting Started step 1d.
      </Typography>
      <Typography variant="body1" align="left" className={classes.body}>
        <b>Project Start Date:</b> Defaults to earliest created date from the imported csv. Use this if the project had a long delay with tickets left in progress. For example if you have a project that expands over Christmas, set the project start date to the Monday after the holidays so the tickets left open over Christmas are not accounted for. 
      </Typography>
      <Typography variant="body1" align="left" className={classes.body}>
        <b>Lead Time:</b> Defaults to the last 11 tickets, if there are less than 11 tickets it will include however many are available. Use this if you want to override the 11 ticket lead times, enter lead times as integers separated by commas (1,2,3,4,5). For example, if you have a project that has not been started yet or is in the early stages of development, you can input the lead times of the past few tickets from another project to get a prediction.
      </Typography>
      <Typography variant="body1" align="left" className={classes.body}>
